...
export const getInterviewReportByIdThunk = createAsyncThunk(
  "interview/get-report-by-id",
...
export const getAllInterviewReportsThunk = createAsyncThunk(
  "interview/get-all-reports",
...
export const generateInterviewReportThunk = createAsyncThunk(
...
export const generateResumePdfThunk = createAsyncThunk(
  "interview/generate-resume-pdf",
  async (interviewId, { rejectWithValue }) => {
    try {
      const res = await api.get(`/v1/interview/resume-pdf/${interviewId}`, {
        responseType: "blob",
      });
